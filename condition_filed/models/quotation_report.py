    ...
    def generate_xlsx_report(self, workbook, data, orders):
        ...
        for obj in orders:
            ...
            if obj.incoterms:
                ...
                sheet.merge_range(table_row, 3, table_row, 8, incoterms, format_4)
                table_row += 2
...
'''
            ...
            table_row += 3
            sheet.merge_range(table_row, 0, table_row, 8,'1. Definitions', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 3, table_row, 8,'An entity that places an order for goods or services. The Sold-to party or Customer can be, but is not necessarily, the Bill-to party, Ship-to party, or the Payer.', format_5)
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 2,'1.2 “Product(s)”', format_5)
            sheet.merge_range(table_row, 3, table_row, 8,'The goods sold and/or services provided from Metra to the Customer in a given transaction, including but not limited to hardware products, software licenses, warranty, and services.', format_5)
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 2,'1.3 “Payer”', format_5)
            sheet.merge_range(table_row, 3, table_row, 8,'An entity that has the obligation to pay a bill or invoice to Metra, including VAT if applicable, as nominated by the Customer.', format_5)
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 2,'1.4 “Bill-to party”', format_5)
            sheet.merge_range(table_row, 3, table_row, 8,'An entity nominated by the Customer to whom Metra shall send its invoices for payment of the Products price or any other dues under these terms and conditions.', format_5)
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 2,'1.5 “Ship-to party”', format_5)
            sheet.merge_range(table_row, 3, table_row, 8,'Any entity that will receive the Products from Metra. This can be either the Customer or a third party nominated by the Customer. ', format_5)
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 2,'1.6 “End-User”', format_5)
            sheet.merge_range(table_row, 3, table_row, 8,'An entity that has been provided to Metra by the Sold-to party, where the Sold-to party has informed Metra that they intend to resell the goods to it. It is mandatory that the Sold-to party doesn’t resell the goods to any party other than the end-user intended. ', format_5)
            table_row += 2




            sheet.merge_range(table_row, 0, table_row, 8,'2. Quotations/Orders/Contract', format_6)
            table_row += 1
...
'''
            ...
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 8,'4. Payment Terms & Payment Obligation', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'5. Fair Pricing', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'6. Delivery/Title/Risk', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'7. Service/ Software Orders', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'8. Holding Fees', format_6)
            table_row += 1
...
'''
            ...
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 8,'9. Acceptance and Returns', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'10. Trade and Import Authorizations', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'11. Export Control', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'12. Foreign Corrupt Practices Act ("FCPA")', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'13. Right of Review and Audit', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'14. Assignment', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'15. Communication & Confidentiality', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,'16. Governing Law', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,tetx_term_16_1, format_5)
            
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 8,'17. Digital Acceptance', format_6)
            table_row += 1
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,tetx_term_17_1, format_5)
...
'''
            ...
            sheet.merge_range(table_row, 0, table_row, 8,tetx_sign, format_5)
            ...
            sheet.merge_range(table_row, 2, table_row, 8,obj.partner_id.name, )
            
            table_row += 2
            sheet.merge_range(table_row, 0, table_row, 1,'Date:', format_5)
            sheet.merge_range(table_row, 2, table_row, 8,obj.signed_on,date_format)
